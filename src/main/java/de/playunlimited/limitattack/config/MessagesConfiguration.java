...
public class MessagesConfiguration extends JsonConfiguration {
    ...
    public MessagesConfiguration(@NotNull JsonConfigurationType configurationType, @NotNull File configurationFile, @NotNull String classpathFile) {
        ...
        this.COMMAND_GAMEMODE_ALREADY_MODE = coreMessagesConfiguration.PREFIX + getString("commands.gamemode.messages.alreadyMode");
        this.COMMAND_GAMEMODE_CHANGED_MODE = coreMessagesConfiguration.PREFIX + getString("commands.gamemode.messages.changedMode");
